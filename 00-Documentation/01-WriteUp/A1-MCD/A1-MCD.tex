...
emittance, etc., as the beam progresses through the beam line. 
...
\texttt{outputCSVfile} is the output file, in CSV format, contining
the beam paramters at the locations traversed by the beam.
\texttt{startlocation} is the location along the beam line at which
propagation will start.
If absent or None propagation will start at the soruce.
