...
\paragraph{Instanciation} ~\newline
\noindent
The call to instanciate the \texttt{Facility} derived class is:
\begin{center}
  \texttt{BeamLineElement(Name, rStrt, vStrt, drStrt, dvStrt, p0, VCMV)}
\end{center}
...
\begin{table}[h]
  \caption{
    ...
    All attributes are required in the call to instanciate the
    element.
  }
