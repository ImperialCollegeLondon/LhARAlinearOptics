...
Sol  = BLE.Solenoid("ValidSolenoid1", rStrt, vStrt, drStrt, dvStrt, \
                    0.5, 1.4)
refPrtclSet = iRefPrtcl.setReferenceParticle(Sol)
Sol1 = BLE.Solenoid("ValidSolenoid2", rStrt, vStrt, drStrt, dvStrt, \
                    0.5, None, 2.155024734419047)
refPrtclSet = iRefPrtcl.setReferenceParticle(Sol1)
...
RprimeTest = np.array([-0.057053437, -0.027118015, \
                       -0.167527585, 0.095646901, \
                       0., 0. ])
